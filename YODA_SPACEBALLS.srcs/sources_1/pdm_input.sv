...
module pdm_inputs #(
    ...
    // Counter and clock initialization
    initial begin
    sample_counter = '0;
    counter        = '0;
    m_clk          = '0;
    ...
    // Toogles Mic clk at 2.4MHz by checking a counter against
    // the 100MHZ clock
...
// Delta-Sigma Modulator to output amplitude value and
// toggles valid amplitude flag
	if (m_clk_en) begin
